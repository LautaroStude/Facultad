...
carpeta = "/home/Estudiante/Descargas/sql/"
...
consultaSQL = """
               ...
               FROM pasajero, reserva
               WHERE pasajero.DNI = reserva.DNI AND Precio < 200
              """
...
consultaSQL = """
                ...
                FROM pasajero, dniPersonasDesdeMadrid
                WHERE pasajero.DNI = dniPersonasDesdeMadrid.DNI
              """
...
consultaSQL = """
                ...
                FROM examen
                HAVING instancia LIKE 'Parcial-01%'
              """
